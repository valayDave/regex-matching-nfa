...
#SBATCH -o agave-out/multi-file.%j.out            	 	# STDOUT (%j = JobId)
#SBATCH -e agave-out/multi-file.%j.err             	# STDERR (%j = JobId)
...
./search "and+gr(e)*n" Testing-Files/anne.txt 
echo "==========================================================================="

echo "=============================== SERIAL CODE : 2 File ==============================="
./search "and+gr(e)*n" Testing-Files/anne.txt Testing-Files/tale.txt
echo "==========================================================================="
...
./psearch "and+gr(e)*n" Testing-Files/anne.txt 
echo "==========================================================================="

echo "=============================== PARALLEL CODE : 2 File ==============================="
./psearch "and+gr(e)*n" Testing-Files/anne.txt Testing-Files/tale.txt
echo "==========================================================================="
